...
void LandScapeUI::render_update()
{
	...
	ImGui::Text("FaceCountX"); ImGui::SameLine();
	if (ImGui::InputInt("##LS_FaceCountX", &m_iXFaceCount) && m_bChangeFaceCount == false)
	{
		m_bChangeFaceCount = true;
	}
	ImGui::Text("FaceCountZ"); ImGui::SameLine(); 
	if (ImGui::InputInt("##LS_FaceCountZ", &m_iZFaceCount) && m_bChangeFaceCount == false)
	{
		m_bChangeFaceCount = true;
	}
