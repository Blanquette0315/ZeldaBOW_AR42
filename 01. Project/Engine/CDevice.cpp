...
int CDevice::CreateSampler()
{
	...
	desc.Filter = D3D11_FILTER_ANISOTROPIC;
	hr = DEVICE->CreateSamplerState(&desc, m_arrSampler[(UINT)SAMPLER_TYPE::ANISOTROPIC_BORDER].GetAddressOf());
	...
	desc.Filter = D3D11_FILTER_ANISOTROPIC;
	hr = DEVICE->CreateSamplerState(&desc, m_arrSampler[(UINT)SAMPLER_TYPE::ANISOTROPIC_MIRROR].GetAddressOf());
	...
	CONTEXT->VSSetSamplers((UINT)SAMPLER_TYPE::ANISOTROPIC_BORDER, 2, m_arrSampler[(UINT)SAMPLER_TYPE::ANISOTROPIC_BORDER].GetAddressOf());
	CONTEXT->HSSetSamplers((UINT)SAMPLER_TYPE::ANISOTROPIC_BORDER, 2, m_arrSampler[(UINT)SAMPLER_TYPE::ANISOTROPIC_BORDER].GetAddressOf());
	CONTEXT->DSSetSamplers((UINT)SAMPLER_TYPE::ANISOTROPIC_BORDER, 2, m_arrSampler[(UINT)SAMPLER_TYPE::ANISOTROPIC_BORDER].GetAddressOf());
	CONTEXT->GSSetSamplers((UINT)SAMPLER_TYPE::ANISOTROPIC_BORDER, 2, m_arrSampler[(UINT)SAMPLER_TYPE::ANISOTROPIC_BORDER].GetAddressOf());
	CONTEXT->PSSetSamplers((UINT)SAMPLER_TYPE::ANISOTROPIC_BORDER, 2, m_arrSampler[(UINT)SAMPLER_TYPE::ANISOTROPIC_BORDER].GetAddressOf());
	CONTEXT->CSSetSamplers((UINT)SAMPLER_TYPE::ANISOTROPIC_BORDER, 2, m_arrSampler[(UINT)SAMPLER_TYPE::ANISOTROPIC_BORDER].GetAddressOf());

	CONTEXT->VSSetSamplers((UINT)SAMPLER_TYPE::ANISOTROPIC_MIRROR, 1, m_arrSampler[(UINT)SAMPLER_TYPE::ANISOTROPIC_MIRROR].GetAddressOf());
	CONTEXT->HSSetSamplers((UINT)SAMPLER_TYPE::ANISOTROPIC_MIRROR, 1, m_arrSampler[(UINT)SAMPLER_TYPE::ANISOTROPIC_MIRROR].GetAddressOf());
	CONTEXT->DSSetSamplers((UINT)SAMPLER_TYPE::ANISOTROPIC_MIRROR, 1, m_arrSampler[(UINT)SAMPLER_TYPE::ANISOTROPIC_MIRROR].GetAddressOf());
	CONTEXT->GSSetSamplers((UINT)SAMPLER_TYPE::ANISOTROPIC_MIRROR, 1, m_arrSampler[(UINT)SAMPLER_TYPE::ANISOTROPIC_MIRROR].GetAddressOf());
	CONTEXT->PSSetSamplers((UINT)SAMPLER_TYPE::ANISOTROPIC_MIRROR, 1, m_arrSampler[(UINT)SAMPLER_TYPE::ANISOTROPIC_MIRROR].GetAddressOf());
	CONTEXT->CSSetSamplers((UINT)SAMPLER_TYPE::ANISOTROPIC_MIRROR, 1, m_arrSampler[(UINT)SAMPLER_TYPE::ANISOTROPIC_MIRROR].GetAddressOf());
