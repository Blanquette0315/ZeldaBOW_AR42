...
enum LINK_ANIM_CONDITION
{
    ...
    LAC_KEY_LBTN        = 0x00000020,
    LAC_KEY_LBTN_COMBO  = 0x00000040,
    LAC_KEY_RBTN        = 0x00000080,

    LAC_MODE_WALK       = 0x00000100,
    LAC_MODE_RUN        = 0x00000200,
	LAC_MODE_LOCKON		= 0x00000400,

    LAC_ANIM_FINISHED   = 0x00000800,
    LAC_TOE_L_FRONT     = 0x00001000,
    LAC_TURN_BACK       = 0x00002000,
    LAC_GROUNDED		= 0x00004000,

	LAC_DAMAGED_FRONT	= 0x00008000,
	LAC_DAMAGED_BACK	= 0x00010000,
	LAC_DAMAGED_LEFT	= 0x00020000,
	LAC_DAMAGED_RIGHT	= 0x00040000,

	LAC_DAMAGED_SMALL	= 0x00080000,
	LAC_DAMAGED_MEDIUM	= 0x00100000,
	LAC_DAMAGED_LARGE	= 0x00200000,

	LAC_DEAD			= 0x00400000,

	LAC_EQUIP_SWORD		= 0x00800000,
	LAC_EQUIP_BOW		= 0x01000000,
